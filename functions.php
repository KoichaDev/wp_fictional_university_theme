...
// functions.php is like having a conversation with the wordpress system itself
    ...
    function kho_university_files() {
        ...
        if(strstr($_SERVER['SERVER_NAME'], 'localhost')) { // this will be for development purpose
            ...
            wp_enqueue_script('kho_bundled_university_script', get_theme_file_uri('/bundled-assets/scripts.7cf98c5fad01ce7bfed4.js') , NULL, '1.0', true);            
            wp_enqueue_style('kho_university_styles', get_theme_file_uri('/bundled-assets/styles.7cf98c5fad01ce7bfed4.css'));
        }
